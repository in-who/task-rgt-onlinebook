...
## 🛠️ 설치 방법
git clone [https://github.com/in-who/task-rgt-onlinebook.git]
npm install
npm run dev
...
## 🔄 변경 이력
- **2025-05-02**: Jest 테스트 환경 추가 및 테스트 케이스 구현
- **2025-05-01**: 프로젝트 초기 구성 완료 original git (https://github.com/LordMashh/Bookstore-Next.git)

### 주요 변경 사항
- Jest 테스트 스크립트 추가 (`npm test` 지원)
- BookCard 컴포넌트 테스트 케이스 구현
- SeeAll 페이지 로딩 상태 테스트 추가
...
### 테스트 환경 선택 이유
- Jest: React 생태계 표준 테스트 도구
- Testing Library: 실제 사용자 경험 기반 테스트 가능
